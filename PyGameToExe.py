...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "AStarEGC-GUI.py"
 
        #Name of program
        self.project_name = "AStarECG"
        ...
        #Auhor of program
        self.author_name = "Omar Verduga"
        self.author_email = ""
        self.copyright = "2014 Omar Verduga."
        ...
        self.extra_scripts = ["AStar", "Camino","Nodo","Lugar"]
